...
<html>
    ...
    <body>
        ...
        <div class="form">
            <ul class="tab-group">
                <li class="tab"><a href="#addschools">Add Departments</a></li>
                <li class="tab active"><a href="#viewschools">View Departments</a></li>
            </ul>
            <div class="tab-content">
                <div id="viewschools">   
                    <?php
                    require '../Controller/Departments_view.php';
                    ?>
                </div>
                <div id="addschools">   
                    <h1 style="color: #FFFFFF;">Enter all the relevant details here</h1>

                    <form action="../Controller/adddp.php" method="post">

                        <div class="top-row">
                            <div class="form-group field-wrap">
                                <label>Name<span class="req">*ex education</span>
                                </label>
                                <input type="text" required autocomplete="on" name='dpname' style="color: #FFFFFF;" />
                            </div>
