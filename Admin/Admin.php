            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navHeaderCollapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="index.html"><img src="../resources/images/home.ico" alt="Home" class="image-responsive image-circular icon"/><b>Home</b></a></li>
                        <li><a href="Add_register.php"> <img src="../resources/images/admin.png" alt="Administrators" class="image-responsive image-circular icon"/><b>Administrators</b></a></li>
                        <li><a href="Add_register.php"> <img src="../resources/images/Schools-Icon.png" alt="Schools" class="image-responsive image-circular icon"/><b>Schools</b></a></li>
