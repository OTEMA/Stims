...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navHeaderCollapse">
                    <ul class="nav navbar-nav" >
                        ...
                        <li><a href="manage_admins.php"> <img src="../resources/images/admin.png" alt="Administrators" class="image-responsive image-circular icon"/><b>Administrators</b></a></li>
                        <li><a href="manage_schools.php"> <img src="../resources/images/Schools-Icon.png" alt="Schools" class="image-responsive image-circular icon"/><b>Schools</b></a></li>
                        <li><a href="manage_departments.php"> <img src="../resources/images/departments.png" alt="Departments" class="image-responsive image-circular icon"/><b>Departments</b></a></li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="Programs/Phd.php"><i>Phd</i></a></li>
                                <li class="divider"></li>
                                <li><a href="Programs/Masters.php"><i>Masters</i></a></li>
                                <li class="divider"></li>
                                <li><a href="Programs/Degree.php"><i>Degree</i></a></li>
                                <li class="divider"></li>
                                <li><a href="Programs/Diploma.php"><i>Diploma</i></a></li>
                                <li class="divider"></li>
                                <li><a href="Programs/Certificate.php"><i>Certificate</i></a></li>
                            </ul>
                        </li>  
        ...
        <div class="controls">
        <a href="../Controller/logout.php" float="right"><button class="btn btn-block btn-danger" name="logout"/>Log Out</button></a>
        </div>
