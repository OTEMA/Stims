...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2017 at 09:27 AM
...
CREATE TABLE `staffs` (
  ...
  `Hash` text NOT NULL,
  `DOE` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `staffs` (`Fname`, `Mname`, `Lname`, `StaffNo`, `Department`, `IdNo`, `Tel`, `Email`, `Password`, `Hash`, `DOE`, `Is_Admin`, `active`, `Image`) VALUES
('Tosby', 'Tosby', 'Tosby', '123456', 1, 123456, '0702293572', 'otienolucie6@gmail.com', '$2y$10$tt.H/SIdIq.2fNLpyOR9E.uxETQsU6wTlcFJtrQ3qNRXQWg0uISMC', '149e9677a5989fd342ae44213df68868', '2017-07-25 15:57:54', 0, 0, ''),
('Test', 'Test', 'Test', 'Test', 1, 28789722, 'Test', 'test@test.com', '$2y$10$jO78.tvtxBUhEAskgvD29OoUWl7WexYkiuFcJDiSirDzHqG8cpssu', '07cdfd23373b17c6b337251c22b7ea57', '2017-07-25 15:58:05', 1, 0, '');
...
--
ALTER TABLE `staffs`
  ADD CONSTRAINT `staffs_ibfk_1` FOREIGN KEY (`Department`) REFERENCES `department` (`Department_id`) ON DELETE CASCADE ON UPDATE CASCADE;
